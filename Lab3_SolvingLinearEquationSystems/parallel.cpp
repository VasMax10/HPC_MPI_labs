...
// Function for initialization of the matrix and the vector elements from file
                           ...
                           double *&pProcResult, int &Size, int &RowNum)
{
    ...
    if (ProcRank == 0)
    {
        printf("\nSize of the matrix and the vector = %d", Size);
...
void DataDistribution(double *pMatrix, double *pProcRows, double *pVector,
                      double *pProcVector, int Size, int RowNum, int64_t &scatterTime)
{
...
int main(int argc, char *argv[])
{
    ...
    DataDistribution(pMatrix, pProcRows, pVector, pProcVector, Size, RowNum, scatterTime);
